...
$field_name = !empty($parent_id)
    ...
    : $page_database_id . '[' . $id . ']';
$field_value = $value;
$field_class = BVI_PLUGIN_MEGAMENU_NAMESPACE . '-html-field';

$field_before = $options['before_field'] ?? '';
$field_after = $options['after_field'] ?? '';
...
<div class="<?php echo BVI_PLUGIN_MEGAMENU_NAMESPACE; ?>-field <?php echo $field_class; ?>" id="<?php echo BVI_PLUGIN_MEGAMENU_NAMESPACE; ?>_<?php echo $id; ?>">
    ...
    <textarea id="<?php echo $id; ?>_id" name="<?php echo $field_name; ?>"><?php echo $field_value; ?></textarea>

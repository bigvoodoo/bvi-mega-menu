	...
	[
		...
		[
			[
				'core/column',
				{},
				[['core/heading', { level: 4, placeholder: 'Section' }]],
			],
			[
				'core/column',
				{},
...
registerBlockType(metadata.name, {
	edit: function Edit({ attributes, setAttributes }) {
		const { panelBackground, panelPadding, panelMaxWidth, panelAlign } =
			attributes;
		...
		return (
			<>
				...
				<InspectorControls>
					<PanelBody
						title={__('Panel Layout', 'bvi-mega-menu')}
						initialOpen={true}
					>
						<UnitControl
						...
						<UnitControl
							...
							units={UNITS_SIZE}
							onChange={(value) =>
								setAttributes({ panelMaxWidth: value || '' })
							}
							help={__(
						...
						<SelectControl
							...
							onChange={(value) =>
								setAttributes({ panelAlign: value })
							}
						/>
					</PanelBody>
				</InspectorControls>

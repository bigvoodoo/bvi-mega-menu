        ...
        <Placeholder
          ...
          instructions={
            isAutoDetect || isDefaultSettings
              ? __(
                  'Will auto-detect the Mega Menu block on this page, or use' + ' the default menu from Settings.',
                  'bvi-mega-menu'
                )
              : __('Configured to use a specific menu. Adjust in block settings.', 'bvi-mega-menu')
          }
        >
          {isLoading ? (
            <Spinner />
